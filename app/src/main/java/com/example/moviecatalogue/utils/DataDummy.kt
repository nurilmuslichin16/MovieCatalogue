...
object DataDummy {
    ...
    fun generateRemoteDummyTv(): List<MovieResponse> {

        val tv = ArrayList<MovieResponse>()

        tv.add(MovieResponse("t1",
            "https://image.tmdb.org/t/p/w600_and_h900_bestv2/wGFUewXPeMErCe2xnCmmLEiHOGh.jpg",
            "The Arrow",
            "2012",
            "6.5",
